...
function AppSaleHistory(){
    ...
    const getData = async () => {
      try {
        const res = await fetch(
          "https://sheet.best/api/sheets/670762db-3d19-4d72-8348-85b19e894d9a/tabs/salehistory?_format=index"
        );
    ...
    const handleDelete = async (rowIndex) => {
      try {
        const res = await fetch(`https://sheet.best/api/sheets/670762db-3d19-4d72-8348-85b19e894d9a/tabs/salehistory/${rowIndex}`,
          {
            method: "DELETE",
          }
        );
